...
/*
	Object pass to the uniform buffer. Act as a global variable to not need to constantly update it

	CAREFUL WITH MEMORY ALIGNMENTS
*/
...
private:
	...
	*/
	void initWindow() {
		...
		//Tells glfw to not generate a context (residual from openGL)
		glfwWindowHint(GLFW_CLIENT_API, GLFW_NO_API);

		//create a window, width, height, name, monitor
	...
	*/
	...
	//Prepare the debugmessenger for the validation layers
	...
	//Pick the first physical device that support all the extensions required.
	...
	/*
		Creates a logicla device as interface to the physical one
	*/
	...
	*/
	...
	/*
		Create the descriptor layout, use to pass uniform attributes to the shaders
	*/
	...
	*/
	...
	/*
		copy from src buffer into dst buffer
	*/
	...
	*/
	void createVertexBuffer() {
		...
		//copy the verteces to the stagging buffer
		void* data;
		...
		//copy from the staging buffer to the vertex buffer on HIGH performance memory
	...
	*/
	void createUniformBuffers() {
		...
		//Resize the vecotr to match number with swapchain images
	...
	/*
		Create a descriptor set for each VKbuffer resource to bind the uniform buffer descriptor
	*/
	...
	/*
		Create the descriptor sets to add to the descriptor pool
	*/
	...
	*/
	...
	/*
		Update the uniform buffer of a concret image
	*/
	...
	*/
	void drawFrame() {
		...
		//Update the transform of the object and the buffers
